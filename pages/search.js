...
export default function Search({ searchResults }) {
  ...
  return (
    <>
      ...
      <Header searchPage placeholder={`${location} | ${range} | ${noOfGuests}`} />

      <main className="mt-[80px] flex pl-6">
        <div className="flex w-full">
          <section className="flex-1 pr-6 lg:pr-0">
          ...
          <section className="min-h-screen ml-8 hidden lg:flex lg:flex-1">
